...
<div class="mask d-flex align-items-center h-100">
    <div class="container">
        <div class="d-flex justify-content-between my-4">
            <h2 class="">Vínculos</h2>


            <!-- Empréstimo de Livros -->
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-secondary btn-sm px-3" data-bs-toggle="modal" data-bs-target="#formNewRental">
                ...
                <button type="button" class="btn btn-secondary btn-sm px-3 ms-2" data-bs-toggle="modal" data-bs-target="#formNewBookStudent">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
                        <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
                    </svg> Dar Baixa
            ...
            <div class="modal fade" id="formNewRental" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="formNewBookLabel" aria-hidden="true">
                            ...
                            <div class="card-body p-4">
                                <form action="/register_book" method="POST">
                                    ...
                                    <div class="mb-md-5 mt-md-4 pb-5">
                                        <h2 class="modal-title">Novo Vínculo</h2>
                                        <p class="text-white-50 mb-5">Por favor insira os dados do estudante que irá retirar o livro!</p><br>


                                        <div class="form-outline form-white mb-4">
                                            <label class="form-label d-block text-start">Nome do estudante:</label>
                                            <select class="form-select form-control form-control-lg" name="student_id" id="student_id">
                                                <option disabled selected hidden>Estudante...</option>
                                        ...
                                        <div cl ass="form-outline form-white mb-4">
                                            ...
                                            <select class="form-select form-control form-control-lg" name="book_id" id="book_id">
                                                <option disabled selected hidden>Livro...</option>
            ...
            <div class="modal fade" id="formNewBookStudent" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="formNewBookLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="card bg-dark text-white m-0">
                            <button type="button" class="btn btn-dark ms-auto m-3 p-2" data-bs-dismiss="modal" aria-label="Close"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="formEditBook{{ $book->id }}" tabindex="-1" aria-labelledby="formEditBookLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="card bg-dark text-white m-0">
                                                            <button type="button" class="btn btn-dark ms-auto m-3 p-2" data-bs-dismiss="modal" aria-label="Close"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                                                                ...
                                                                <form action="{{ route('edit_book', ['book' => $book]) }}" method="POST">
                                                                    ...
                                                                    <div class="mb-md-5 mt-md-4 pb-5">
                                                                        ...
                                                                        <div class="form-outline form-white mb-4">
                                                                            ...
                                                                            <input type="text" id="title" name="title" class="form-control form-control-lg" value="{{ $book->title }}">
                                                                        </div>

                                                                        <div class="form-outline form-white mb-4">
                                                                            <label class="form-label d-block text-start">Autor:</label>
                                                                            <select class="form-select form-control form-control-lg" name="student_id" id="student_id">
                                                                                <option selected hidden value=" {{ $book->student_id }}">
                                                                                </option>
                                                                                @foreach ($students as $student)
                                                                        ...
                                                                        <div class="form-outline form-white mb-4">
                                                                            ...
                                                                            <select class="form-select form-control form-control-lg" name="book_id" id="book_id">
                                                                                <option selected hidden value=" {{ $book->book_id }}">
                                                                                </option>
                                                                                @foreach ($books as $book)
                                                                        ...
                                                                        <div class="form-outline form-white mb-4">
                                                                            <label class="form-label d-block text-start">Numero
                                                                                de Paginas:</label>
                                                                            <input type="number" id="page" name="page" class="form-control form-control-lg" value="{{ $book->page }}" data-mask="0000">
                                                                        </div>
