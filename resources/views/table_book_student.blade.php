                                        ...
                                        <form action="/register_book" method="POST">
                                            ...
                                            <div class="mb-md-5 mt-md-4 pb-5">
                                                ...
                                                <div class="form-outline form-white mb-4">
                                                    ...
                                                    <select class="form-select form-control form-control-lg" name="student_id"
                                                        id="student_id">
                                                ...
                                                <div class="form-outline form-white mb-4">
                                                    ...
                                                    <select class="form-select form-control form-control-lg" name="book_id"
                                                        id="book_id">
                                                        <option disabled selected hidden>Escolha...</option>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    <div class="card bg-dark text-white m-0">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <form
                                                                                action="{{ route('edit_book', ['book' => $book]) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                <div class="mb-md-5 mt-md-4 pb-5">
                                                                                    <h2 class="modal-title">Novo Livro</h2>
