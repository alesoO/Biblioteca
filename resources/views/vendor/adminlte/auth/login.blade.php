...
<form action="{{ $login_url }}" method="post">
    ...
    <div class="input-group mb-3">
        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Insira seu e-mail" autofocus>
    ...
    <div class="row">
        <div class="col-7">
            <div class="icheck-primary d-flex justify-content-start align-items-center" title="{{ __('adminlte::adminlte.remember_me_hint') }}">
                <input class="" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>

                <label class="text-center ms-2 mt-2 " for="remember">
                    Lembre-se de mim
                </label>
            </div>
        </div>
...
<div class="ms-2 mb-3 d-flex justify-content-start">
    <a class="mx-auto my-2" href="{{ $register_url }}">
