            ...
            <div class="mask d-flex align-items-center h-100">
                <div class="container">
                    <div class="d-flex justify-content-between my-4">
                        ...
                        <div class="modal fade" id="formNewStudent" role="dialog" data-bs-backdrop="static"
                            data-bs-keyboard="false" tabindex="-1" aria-labelledby="formNewStudentLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="/register_student" method="POST" class="p-4 bg-light form-container">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label d-block text-start" for="school_year">Ano
                                                    Escolar:</label>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label d-block text-start"
                                                    for="registration">Matricula:</label>
                                                <input type="number" id="registration" name="registration" class="form-control"
                                                    data-mask="000000" placeholder="Insira a matrícula do estudante">
                                            </div>
                                        </div>
                                                ...
                                                @foreach ($students as $student)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            {{ $student->created_at->format('d/m/Y H:i:s') }}</td>
                                                        <td class="text-center">
                                                            {{ $student->updated_at->format('d/m/Y H:i:s') }}</td>
                                                        <td class="text-center">
                                                            ...
                                                            <div class="modal fade" id="formEditStudent{{ $student->id }}"
                                                                ...
                                                                aria-labelledby="formNewStudentLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title text-center"
                                                                                id="formNewStudentLabel">
                                                                                <h3><b>Editar Estudante</b></h3>
                                                                            </h5>
                                                                        ...
                                                                        <form
                                                                            ...
                                                                            method="POST"
                                                                            class="p-4 bg-light form-container">
                                                                            @csrf
                                                                            <div class="modal-body">
                                                                                <div class="form-group">
                                                                                    <label
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        class="form-label d-block text-start"
                                                                                        for="school_year">Ano Escolar:</label>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number" id="registration"
                                                                                        ...
                                                                                        data-mask="000000"
                                                                                        placeholder="Insira a matrícula do estudante">
                                                                                </div>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                        ...
                                                        <td class="text-center">
                                                            <button type="submit" class="btn btn-danger btn-sm px-3"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#warning{{ $student->id }}">
                                                                <i class="fas fa-times"></i>
                                                            </button>
                                                            <div class="modal fade" id="warning{{ $student->id }}"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            Tem certza que deseja apagar o Estudante ?
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary"
