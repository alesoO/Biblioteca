    ...
    <div class="mask d-flex align-items-center h-100">
        <div class="container">
            <div class="d-flex justify-content-between my-4">
                <h2 class=""><b>Autores</b></h2>
                <button type="button" class="btn btn-primary btn-sm mb-4 py-2" data-bs-toggle="modal" data-bs-target="#formNewAuthor">
                ...
                <div class="modal fade" id="formNewAuthor" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="formNewauthorLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-center" id="formNewauthorLabel"><h3><b>Novo Autor</b></h3></h5>
                            ...
                            <form action="/register_author" method="POST" class="p-4 bg-light" id="add_author_form">
                                ...
                                <div class="modal-body">
                                    <div class="form-outline form-white mb-4">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Digite o nome do autor">
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $author->name }}</td>
                                            <td class="text-center">{{ $author->created_at->format('d/m/Y H:i:s') }}</td>
                                            <td class="text-center">{{ $author->updated_at->format('d/m/Y H:i:s') }}</td>
                                            <td class="text-center">
                                                <button type="button" class="btn btn-warning btn-sm px-3" data-bs-toggle="modal" data-bs-target="#formEditAuthor{{ $author->id }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                    </svg>
                                                </button>
                                                <div class="modal fade" id="formEditAuthor{{ $author->id }}" tabindex="-1" aria-labelledby="formEditAuthorLabel" aria-hidden="true">
                                            ...
                                            <td class="text-center">
                                                <button type="submit" class="btn btn-danger btn-sm px-3" data-bs-toggle="modal" data-bs-target="#warning{{ $author->id }}">
                                                    <i class="fas fa-times"></i>
                                                </button>
                                                <div class="modal fade" id="warning{{ $author->id }}" tabindex="-1" aria-labelledby="warningLabel" aria-hidden="true">
