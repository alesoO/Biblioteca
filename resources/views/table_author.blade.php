    ...
    <div class="mask d-flex align-items-center h-100">
        <div class="container">
            <div class="d-flex justify-content-between my-4">
                <h2 class="">Autores</h2>
                <button type="button" class="btn btn-secondary btn-sm mb-4 py-2" data-bs-toggle="modal" data-bs-target="#formNewAuthor">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="card bg-dark text-white m-0">
                                                                ...
                                                                <div class="card-body">
                                                                    <form action="{{ route('edit_author', ['author' => $author]) }}" method="POST">
                                                                        @csrf
                                                                        <div class="mb-md-5 mt-md-4 pb-5">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('delete_author', ['author' => $author]) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
