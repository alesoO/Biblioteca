...
<main>
    ...
    <li class="nav-item">
        <div class="dropdown display_desktop">
            <button class="btn btn-outline-primary d-flex justify-content-center align-items-center mt-2 dropdown-toggle fs-4" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul class="dropdown-menu">
                ...
                <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#warning{{ auth()->user()->id }}">
    ...
    <div class="display_mobile">
        <form class="d-flex justify-content-center flex-fill" action="/logout" method="post">
            @csrf
            <button type="submit" class="flex-fill p-2 fs-4 m-2 mx-3 header_buttons btn btn-danger">Sair</button>
        </form>
    </div>
    ...
    <li class="nav-item"><a href="/login" class="d-block p-2 fs-4 m-2 mx-3 header_buttons btn btn-outline-primary">Login</a></li>
    <li class="nav-item"><a href="/register" class="d-block p-2 fs-4 m-2 mx-3 header_buttons btn btn-primary">Cadastro</a></li>
    </div>
    @endauth
        </div>
    </div>
        ...
        <div class="mt-4 row">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <a href="/table_publisher" class="small-box-footer">Ver Mais... <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                    ...
                    <div class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="61" height="70" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
                            <path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811V2.828zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492V2.687zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z" />
                        </svg>
                    </div>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <div class="col-md-4 d-flex align-items-center">
                <a href="" class="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="24" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
                        <path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811V2.828zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492V2.687zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783z" />
                    </svg>
                </a>
