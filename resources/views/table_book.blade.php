...
<div class="mask d-flex align-items-center h-100">
    <div class="container">
        <div class="d-flex justify-content-between my-4">
            ...
            <div class="modal fade" id="formNewBook" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="formNewBookLabel" aria-hidden="true">
                                ...
                                <form action="/register_book" method="POST">
                                    ...
                                    <div class="mb-md-5 mt-md-4 pb-5">
                                        ...
                                        <div class="form-outline form-white mb-4">
                                            ...
                                            <select class="form-select form-control form-control-lg" name="author_id" id="author_id">
                                        ...
                                        <div class="form-outline form-white mb-4">
                                            ...
                                            <select class="form-select form-control form-control-lg" name="publisher_id" id="publisher_id">
                                                <option disabled selected hidden>Escolha...</option>
                                        ...
                                        <div class="form-outline form-white mb-4">
                                            ...
                                            <input type="number" id="page" name="page" class="form-control form-control-lg" data-mask="0000">
                                        </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                                                                        ...
                                                                        <form
                                                                            action="{{ route('delete_book', ['book' => $book]) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
