                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="page" name="page" class="form-control"
                                                data-mask="0000" placeholder="Insira o numero de Paginas">
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="formEditBook{{ $book->id }}"
                                                            ...
                                                            tabindex="-1" aria-labelledby="formNewStudentLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title text-center"
                                                                            id="formNewStudentLabel">
                                                                    ...
                                                                    <form
                                                                        ...
                                                                        method="POST" class="p-4 bg-light form-container">
                                                                        @csrf
                                                                        <div class="modal-body">
                                                                            <div class="form-group">
